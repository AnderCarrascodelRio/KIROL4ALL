...
public class HacerLoginGUI extends JFrame {
	 ...
	 * 
	 */
	public HacerLoginGUI(InicioGUI inicio, BLFacade b) {
		bl = b;
		...
		btnVolver.addActionListener(e -> volverAInicio(inicio)); //Volver a página de inicio
		setVisible(true);
	}
	
	void volverAInicio(InicioGUI a ) {
		a.setVisible(true);
		dispose();
	}
}
